...
import club.axus.axuspixeldungeon.levels.painters.PrisonPainter;
import club.axus.axuspixeldungeon.levels.rooms.Room;
import club.axus.axuspixeldungeon.levels.traps.AlarmTrap;
import club.axus.axuspixeldungeon.levels.traps.BurningTrap;
import club.axus.axuspixeldungeon.levels.traps.ChillingTrap;
import club.axus.axuspixeldungeon.levels.traps.ConfusionTrap;
import club.axus.axuspixeldungeon.levels.traps.FlockTrap;
import club.axus.axuspixeldungeon.levels.traps.GatewayTrap;
import club.axus.axuspixeldungeon.levels.traps.GeyserTrap;
import club.axus.axuspixeldungeon.levels.traps.GrippingTrap;
import club.axus.axuspixeldungeon.levels.traps.OozeTrap;
import club.axus.axuspixeldungeon.levels.traps.PoisonDartTrap;
import club.axus.axuspixeldungeon.levels.traps.ShockingTrap;
import club.axus.axuspixeldungeon.levels.traps.SummoningTrap;
import club.axus.axuspixeldungeon.levels.traps.TeleportationTrap;
import club.axus.axuspixeldungeon.levels.traps.ToxicTrap;
