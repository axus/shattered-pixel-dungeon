...
package club.axus.axuspixeldungeon.items.armor;
...
import club.axus.axuspixeldungeon.items.armor.curses.AntiEntropy;
import club.axus.axuspixeldungeon.items.armor.curses.Bulk;
import club.axus.axuspixeldungeon.items.armor.curses.Corrosion;
import club.axus.axuspixeldungeon.items.armor.curses.Displacement;
import club.axus.axuspixeldungeon.items.armor.curses.Metabolism;
import club.axus.axuspixeldungeon.items.armor.curses.Multiplicity;
import club.axus.axuspixeldungeon.items.armor.curses.Overgrowth;
import club.axus.axuspixeldungeon.items.armor.curses.Stench;
import club.axus.axuspixeldungeon.items.armor.glyphs.Affection;
...
import club.axus.axuspixeldungeon.items.armor.glyphs.Entanglement;
import club.axus.axuspixeldungeon.items.armor.glyphs.Flow;
import club.axus.axuspixeldungeon.items.armor.glyphs.Obfuscation;
import club.axus.axuspixeldungeon.items.armor.glyphs.Potential;
import club.axus.axuspixeldungeon.items.armor.glyphs.Repulsion;
import club.axus.axuspixeldungeon.items.armor.glyphs.Stone;
import club.axus.axuspixeldungeon.items.armor.glyphs.Swiftness;
import club.axus.axuspixeldungeon.items.armor.glyphs.Thorns;
