...
package club.axus.axuspixeldungeon.items.weapon;
...
import club.axus.axuspixeldungeon.items.weapon.curses.Annoying;
import club.axus.axuspixeldungeon.items.weapon.curses.Displacing;
import club.axus.axuspixeldungeon.items.weapon.curses.Exhausting;
import club.axus.axuspixeldungeon.items.weapon.curses.Fragile;
import club.axus.axuspixeldungeon.items.weapon.curses.Friendly;
import club.axus.axuspixeldungeon.items.weapon.curses.Polarized;
import club.axus.axuspixeldungeon.items.weapon.curses.Sacrificial;
import club.axus.axuspixeldungeon.items.weapon.curses.Wayward;
import club.axus.axuspixeldungeon.items.weapon.enchantments.Blazing;
import club.axus.axuspixeldungeon.items.weapon.enchantments.Blocking;
import club.axus.axuspixeldungeon.items.weapon.enchantments.Blooming;
import club.axus.axuspixeldungeon.items.weapon.enchantments.Chilling;
import club.axus.axuspixeldungeon.items.weapon.enchantments.Corrupting;
import club.axus.axuspixeldungeon.items.weapon.enchantments.Elastic;
import club.axus.axuspixeldungeon.items.weapon.enchantments.Grim;
import club.axus.axuspixeldungeon.items.weapon.enchantments.Kinetic;
import club.axus.axuspixeldungeon.items.weapon.enchantments.Lucky;
import club.axus.axuspixeldungeon.items.weapon.enchantments.Projecting;
import club.axus.axuspixeldungeon.items.weapon.enchantments.Shocking;
import club.axus.axuspixeldungeon.items.weapon.enchantments.Unstable;
import club.axus.axuspixeldungeon.items.weapon.enchantments.Vampiric;
