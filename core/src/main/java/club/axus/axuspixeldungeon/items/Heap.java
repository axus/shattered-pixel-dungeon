...
import club.axus.axuspixeldungeon.items.food.ChargrilledMeat;
import club.axus.axuspixeldungeon.items.food.FrozenCarpaccio;
import club.axus.axuspixeldungeon.items.food.MysteryMeat;
import club.axus.axuspixeldungeon.items.journal.DocumentPage;
