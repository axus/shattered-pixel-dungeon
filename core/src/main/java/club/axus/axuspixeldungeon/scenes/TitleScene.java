...
import club.axus.axuspixeldungeon.effects.Fireball;
import club.axus.axuspixeldungeon.messages.Languages;
import club.axus.axuspixeldungeon.messages.Messages;
import club.axus.axuspixeldungeon.services.news.News;
import club.axus.axuspixeldungeon.services.updates.AvailableUpdateData;
import club.axus.axuspixeldungeon.services.updates.Updates;
...
import club.axus.axuspixeldungeon.windows.WndSettings;
...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		StyledButton btnPlay = new StyledButton(GREY_TR, Messages.get(this, "enter")){
			...
			protected void onClick() {
				if (GamesInProgress.checkAll().size() == 0){
					...
					axusPixelDungeon.switchScene(HeroSelectScene.class);
				} else {
		...
		StyledButton btnRankings = new StyledButton(GREY_TR,Messages.get(this, "rankings")){
			@Override
			protected void onClick() {
				axusPixelDungeon.switchNoFade( RankingsScene.class );
			}
		};
		...
		StyledButton btnBadges = new StyledButton(GREY_TR, Messages.get(this, "badges")){
			@Override
			protected void onClick() {
				axusPixelDungeon.switchNoFade( BadgesScene.class );
			}
		};
		...
		StyledButton btnAbout = new StyledButton(GREY_TR, Messages.get(this, "about")){
			@Override
			protected void onClick() {
				axusPixelDungeon.switchScene( AboutScene.class );
			}
		};
	...
	private static class NewsButton extends StyledButton {
		...
		protected void onClick() {
			super.onClick();
			axusPixelDungeon.switchNoFade( NewsScene.class );
		}
	}
	...
	private static class ChangesButton extends StyledButton {
		...
		protected void onClick() {
			if (Updates.isInstallable()){
				...
				axusPixelDungeon.scene().addToFront( new WndOptions(
					...
					protected void onSelect(int index) {
						if (index == 0) {
							...
							axusPixelDungeon.switchNoFade( ChangesScene.class );
						}
					}
				});
	...
	private static class SettingsButton extends StyledButton {
		...
		protected void onClick() {
			...
			axusPixelDungeon.scene().add(new WndSettings());
		}
	}
	...
	private static class SupportButton extends StyledButton{
		...
		@Override
		protected void onClick() {
			axusPixelDungeon.switchNoFade(SupporterScene.class);
		}
	}
}
