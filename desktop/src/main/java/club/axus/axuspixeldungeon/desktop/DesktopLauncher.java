...
package club.axus.axuspixeldungeon.desktop;
...
import club.axus.axuspixeldungeon.services.news.NewsImpl;
import club.axus.axuspixeldungeon.services.updates.UpdateImpl;
	...
	public static void main (String[] args) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
			...
			public void uncaughtException(Thread thread, Throwable throwable) {
				...
				exceptionMsg = exceptionMsg.replace("club.axus.axuspixeldungeon.", "");
		...
		new Lwjgl3Application(new axusPixelDungeon(new DesktopPlatformSupport()), config);
	}
}
