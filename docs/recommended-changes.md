...
If you wish to set it to 1 anyway, the various constant variables toward the top of [axusPixelDungeon.java](/core/src/main/java/club/axus/axusPixelDungeon/axusPixelDungeon.java) are a good starting point for finding all of the cases where the game refers to the version code for compatibility purposes.
